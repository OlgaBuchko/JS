...
let wrapClass = document.getElementsByClassName('wrap')
...
for (const coursesElement of coursesAndDurationArray) {
    ...
    divCourses.textContent= `${coursesElement.title} - ${coursesElement.monthDuration} month`
}
...
for (const simpson of simpsons) {
    ...
    span.innerText = `Age : ${simpson.age}`
    let p = document.createElement('p')
    p.innerText = `${simpson.info}`
    let img = document.createElement('img')
    img.src = `${simpson.photo}`
    div.append(h1, span, img, p )
}
...
for (const coursesElement of coursesArray) {
    ...
    div.append(h1, span, p, ul)
    h1.innerText = `Tittle: '${coursesElement.title}'`
    span.innerText = `monthDuration: ${coursesElement.monthDuration}`
    p.innerText = `hourDuration: ${coursesElement.hourDuration}`
